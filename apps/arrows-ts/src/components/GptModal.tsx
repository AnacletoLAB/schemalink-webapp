...
import { EntitySelection, Graph, Ontology, Point } from '@neo4j-arrows/model';
...
export const defaultCallbackFactory: CallbackFactory =
  (_, ontologies, graph, separation, clearGraph, importNodesAndRelationships) =>
  (text) =>
